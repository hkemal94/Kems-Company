...
export const CHARACTERS_IMPORT_DATA: ImportCharacter[] = [
  ...
  },
  {
    ...
    "yas": 24,
    "rol": "Dansçı",
    "fizik": "1,72 boyunda, 54 kilo, bakır rengi saçlı, ela gözlü, uzun bacaklı, dik duruşlu",
    "sac": "Uzun, at kuyruğu bakır saçlı",
    "gozler": "",
    "kisilik": "Disiplinli, hırslı, alıngan, sahne açlığı olan",
    "sevdikleri": "Provaya erken gelmek, yeni koreografi, sahne ışığının sıcaklığı",
    "sevmedikleri": "Geç başlayan setler, izinsiz fotoğraf çekilmesi, sakatlık",
    "hobiler": "",
    "ayrinti": [
      "İzmir'de doğmuş ve büyümüştür.",
      "5 yıldır dansçılık sektöründe çalışmaktadır.",
  ...
  },
  {
    ...
    "yas": 29,
    "rol": "Canlı Müzik Yorumcusu",
    "fizik": "1,78 boyunda, 70 kilo, siyah saçlı, koyu gözlü, ince uzun parmaklı",
    "sac": "Arkaya taranmış, kısa siyah saçlı",
    "gozler": "",
    "kisilik": "Sakin, dalgın, duyarlı, sahnede başka biri",
    "sevdikleri": "Gece sonu boş salonda çalışmak, eski plaklar, yağmurlu akşamlar",
    "sevmedikleri": "Konuşarak dinlenen performanslar, akortsuz piyano, alkış beklemek",
    "hobiler": "",
    "ayrinti": [
      "İstanbul'da doğmuş ve büyümüştür.",
      "10 yıldır canlı müzik sektöründe çalışmaktadır.",
  ...
  },
  {
    ...
    "fizik": "1,58 boyunda, 48 kilo, kestane saçlı, ela gözlü, ince yapılı, saçını hep toplu taşıyan",
    "sac": "Omuz hizasında, toplu kestane saçlı",
    "gozler": "",
    "kisilik": "Çekingen, titiz, çalışkan, öğrenmeye istekli",
    "sevdikleri": "Erken saatte işe başlamak, düzenli dolaplar, ustasından iş öğrenmek",
    "sevmedikleri": "Azarlanmak, acele ettirilmek, yarım bırakılmış iş",
    "hobiler": "",
    "ayrinti": [
      "Ankara'da doğmuş ve büyümüştür.",
  ...
  },
  {
    ...
    "yas": 25,
    "rol": "Housekeeping Personeli",
    "fizik": "1,68 boyunda, 58 kilo, koyu kumral saçlı, kahverengi gözlü, hızlı adımlı",
    "sac": "Ense hizasında, koyu kumral saçlı",
    "gozler": "",
    "kisilik": "Pratik, konuşkan, dayanıklı, esprili",
    "sevdikleri": "Kat arkadaşlarıyla çay molası, radyo dinleyerek çalışmak, biten bir katın sessizliği",
    "sevmedikleri": "Son dakika oda değişikliği, dağınık bırakılan banyo, kapı önünde bekletilmek",
    "hobiler": "",
    "ayrinti": [
      "Ankara'da doğmuş ve büyümüştür.",
  ...
  },
  {
    ...
    "yas": 35,
    "rol": "Güvenlik Müdürü",
    "fizik": "1,88 boyunda, 95 kilo, kırlaşmış kısa saçlı, kahverengi gözlü, iri yapılı, ağır hareket eden",
    "sac": "Kısa, kırlaşmış siyah saçlı",
    "gozler": "",
    "kisilik": "Ölçülü, sabırlı, tavizsiz, sesini yükseltmeyen",
    "sevdikleri": "Lobiyi bir kenardan izlemek, kayıt tutmak, sorunu büyümeden çözmek",
    "sevmedikleri": "Kimliksiz giriş, alkollü taşkınlık, kayıt dışı çözüm",
    "hobiler": "",
    "ayrinti": [
      "İstanbul'da doğmuş ve büyümüştür.",
  ...
  },
  {
    ...
    "yas": 30,
    "rol": "Güvenlik Görevlisi",
    "fizik": "1,74 boyunda, 66 kilo, koyu kahve saçlı, gri gözlü, geniş omuzlu",
    "sac": "Topuz yapılmış, koyu kahve saçlı",
    "gozler": "",
    "kisilik": "Soğukkanlı, gözlemci, az konuşan, güvenilir",
    "sevdikleri": "Gece vardiyasının sessizliği, tanıdık yüzler, düzenli devriye",
    "sevmedikleri": "Bağırarak konuşulması, kalabalık lobi, kural pazarlığı",
    "hobiler": "",
    "ayrinti": [
      "İzmir'de doğmuş ve büyümüştür.",
