...
export const KEMSKOY_HOTEL: KemskoyItem = {
  ...
  area: 'duzada',
  // Kemal kararı (14 Eylül 2026): otel bir bölge değil, bir mekân.
  type: 'mekân',
  status: 'Fikir',
  priority: 'yüksek',
...
export const KEMSKOY_GAME_PROJECT: KemskoyItem = {
  ...
  title: 'The Imperial Kemsköy - Oyun Projesi',
  area: 'kitap',
  type: 'kitap_proje',
  status: 'taslak',
  priority: 'yüksek',
...
const BASE_KEMSKOY_PEOPLE: KemskoyItem[] = [
  // PERSONEL
  {
    ...
    metadata: {
      region: 'liman',
      wikiSections: [
        { id: 'bio', title: 'Profil ve Görev', content: 'The Imperial Kemsköy\'un Resepsiyon Müdürü. Gelen misafirlerin evrak kontrolleri, oda dağıtımları ve departman yönlendirmelerinde ana otoritedir.', status: 'öneri' }
      ]
    }
  },
  {
    ...
    metadata: {
      region: 'liman',
      wikiSections: [
        { id: 'bio', title: 'Profil ve Görev', content: 'The Imperial Kemsköy Güvenlik Müdürü. Sorunlu misafirlerin (örn. aşırı alkollü Mehmet Arslan veya kimliksiz refakatçi getiren Sari El-Hassan) otel dışına alınmasını veya odaya ziyaretçi girişlerinin denetimini koordine eder.', status: 'öneri' }
      ]
    }
  },
  ...
  // TEKRAR EDEN MİSAFİRLER
  {
    ...
    links: ['kemskoy_hotel'],
    notes: 'Yaş: 34, Uyruk: Türkiye İş insanı, oteli ve Düzada\'yı çok seviyor, düzenli aralıklarla otelde konaklayan sadık misafir.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    links: ['kemskoy_hotel'],
    notes: 'Yaş: 34, Uyruk: Türkiye Kedisi "Duman" (Van Kedisi) ile birlikte seyahat eden sadık bir misafir. Walk-in olarak otele giriş yapar. Evcil hayvanı için +€50 depozito ve pet pasaportu prosedürüne tabidir.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    notes: 'Yaş: 37, Uyruk: Türkiye Ünlü romancı ve yazar. Otelde ilham arayan tekrar eden misafirlerden biri. Odası 204\'e Leyla Abdallah adında bir ziyaretçi (escort) kabul eder.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    notes: 'Yaş: 36, Uyruk: Türkiye Tekrar eden misafir. Jasmin El-Trabelsi adlı ziyaretçinin 215 numaralı odada ziyaret ettiği kişi.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    links: ['kemskoy_hotel'],
    notes: 'Yaş: 41, Uyruk: Türkiye VIP misafir. Medya hassasiyeti yüksek, prestijli avukat alt-hikayesi olan önemli bir karakter.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    notes: 'Yaş: 52, Uyruk: Türkiye VIP misafir. Refakatçisi Heves Karanfil ile birlikte kalır. Ayrıca 402 numaralı odasında Öykü Toprak adlı ziyaretçi tarafından ziyaret edilir.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    tags: ['misafir', 'kemskoy', 'tekrar eden', 'öneri'],
    links: ['kemskoy_hotel'],
    notes: 'Yaş: 33, Uyruk: Türkiye Düzenli gelen ve otel hizmetlerini iyi tanıyan sadık misafir.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    links: ['kemskoy_hotel'],
    notes: 'Yaş: 31, Uyruk: Hindistan. Seyahat yazarı, oteli ve adayı köşesinde tanıtmak üzere tekrar tekrar ziyaret eden uluslararası misafir.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    tags: ['misafir', 'kemskoy', 'tekrar eden', 'öneri'],
    links: ['kemskoy_hotel'],
    notes: 'Yaş: 26, Uyruk: Türkiye Adada sakin bir tatil arayan genç müdavim.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  // DİĞER MİSAFİRLER
  {
    ...
    links: ['kemskoy_hotel'],
    notes: 'Yaş: 27, Uyruk: Türkiye Rezervasyonsuz gelip müsaitlik durumuna göre oda talep eden walk-in misafir.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    links: ['kemskoy_hotel'],
    notes: 'Yaş: 45, Uyruk: Türkiye Aşırı alkollü olması ve otel düzenini bozma riski taşıması sebebiyle Nusret Demir (Güvenlik) tarafından girişi reddedilen misafir.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    links: ['kemskoy_hotel'],
    notes: 'Yaş: 58, Uyruk: Almanya. Düzada\'nın sonbahar sessizliğini yaşamak için gelen Alman turist.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    links: ['kemskoy_hotel'],
    notes: 'Yaş: 38, Uyruk: Türkiye Girişte kimlik süresi dolduğu fark edilen, bu yüzden alternatif evrak olarak pasaport beyan prosedürü uygulanan misafir.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    notes: 'Yaş: 23, Uyruk: Tunus. 215 numaralı odada kalan Barbaros Yılmaz\'ı ziyaret etmek için gelen yabancı uyruklu ziyaretçi.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    links: ['kemskoy_hotel'],
    notes: 'Yaş: 29, Uyruk: Türkiye Sakin bir tatil geçirmek üzere otele kaydolan misafir.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    tags: ['misafir', 'kemskoy', 'öneri'],
    links: ['kemskoy_hotel'],
    notes: 'Yaş: 29, Uyruk: Türkiye Resepsiyondan sabah uyandırma servisi (wake-up call) talep eden titiz misafir.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    links: ['kemskoy_hotel'],
    notes: 'Yaş: 22, Uyruk: Lübnan. Yanındaki refakatçinin kimliği olmadığı için otele kaydı Nusret Demir (Güvenlik) kararıyla reddedilen Lübnanlı genç.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    tags: ['misafir', 'kemskoy', 'yabancı', 'öneri'],
    links: ['kemskoy_hotel'],
    notes: 'Yaş: 23, Uyruk: Türkmenistan. Adada turistik gezi amacıyla otelde konaklayan Türkmenistan uyruklu misafir.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    notes: 'Yaş: 29, Uyruk: Türkiye 402 numaralı VIP odada kalan sanayici Erdal Sönmez\'i ziyaret etmek üzere gelen misafir.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    tags: ['misafir', 'kemskoy', 'öneri'],
    links: ['kemskoy_hotel'],
    notes: 'Yaş: 30, Uyruk: Türkiye Sezon sonu sakinliğinde iş yorgunluğu atmak isteyen adalı misafir.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    tags: ['misafir', 'kemskoy', 'yabancı', 'öneri'],
    links: ['kemskoy_hotel'],
    notes: 'Yaş: 35, Uyruk: Almanya. Otelin tarihi dokusu ve estetiğiyle ilgilenen Alman sanat tarihçisi.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    links: ['kemskoy_hotel'],
    notes: 'Yaş: 24, Uyruk: Rusya. Otelde boş olan bir odayı ziyaret etmek istediği için Nusret Demir (Güvenlik) tarafından içeri alınması reddedilen Rus turist.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    links: ['kemskoy_hotel'],
    notes: 'Yaş: 28, Uyruk: Türkiye Adadaki meşhur Liman 54 kapanış etkinliğine katılmak amacıyla otelde yer ayırtan genç misafir.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    notes: 'Yaş: 34, Uyruk: Türkiye Eşi Kerem Aksu ile birlikte otele kayıt yaptıran, aile konaklaması gerçekleştiren misafir.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    tags: ['misafir', 'kemskoy', 'walk-in', 'öneri'],
    links: ['kemskoy_hotel'],
    notes: 'Yaş: 44, Uyruk: Türkiye Fırtınalı günde ansızın gelip oda soran walk-in iş seyahatçisi.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    tags: ['misafir', 'kemskoy', 'walk-in', 'öneri'],
    links: ['kemskoy_hotel'],
    notes: 'Yaş: 41, Uyruk: Türkiye Rezervasyonsuz gelip boş odalardan birine yerleşen walk-in müşteri.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    notes: 'Yaş: 63, Uyruk: Almanya. Her yıl eşi Ingrid Brauer ile aynı sezonda gelen, adayı ve oteli evleri gibi gören ihtiyar Alman müdavim.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
      region: 'liman',
      wikiSections: [{ id: 'profil', title: 'Sadık Alman Müdavim', content: '63 yaşında Alman vatandaşı. Eşi Ingrid Brauer ile her yıl aynı dönemde The Imperial Kemsköy\'da konaklar.', status: 'öneri' }]
    }
  },
  {
    ...
    tags: ['misafir', 'kemskoy', 'öneri'],
    links: ['kemskoy_hotel'],
    notes: 'Yaş: 48, Uyruk: Türkiye İş görüşmeleri için adada bulunan ve oteli tercih eden profesyonel.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    links: ['kemskoy_hotel'],
    notes: 'Yaş: 24, Uyruk: Fas. Adadaki kültürel bir konferansa katılmak üzere otelde konaklayan genç Faslı araştırmacı.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    tags: ['misafir', 'kemskoy', 'pasaport', 'evrak-eksik', 'öneri'],
    links: ['kemskoy_hotel'],
    notes: 'Yaş: 55, Uyruk: Türkiye Kimlik süresi dolmuş olduğu için pasaport beyan prosedürü uygulanan orta yaşlı misafir.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    links: ['kemskoy_hotel'],
    notes: 'Yaş: 38, Uyruk: İtalya. Fırtınadan kaçarak otele sığınan ve oda talep eden İtalyan walk-in turist.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    notes: 'Yaş: 25, Uyruk: Mısır. 204 numaralı odada kalan yazar Emir Çeliker\'i ziyaret etmeye gelen Mısırlı ziyaretçi.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    links: ['kemskoy_hotel'],
    notes: 'Yaş: 29, Uyruk: Türkiye Fırtına dolayısıyla otele sığınan ve walk-in oda açtıran genç seyahatçi.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  // REFAKATÇİLER (Companions)
  {
    ...
    links: ['kemskoy_hotel', 'kemskoy_guest_erdal'],
    notes: 'Yaş: 26, Uyruk: Türkiye VIP misafir Erdal Sönmez\'in 402 numaralı Deluxe odasındaki refakatçisi.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    notes: 'Yaş: 36, Uyruk: Türkiye Neslihan Aksu\'nun eşi ve refakatçisi, aile konaklamasının parçası.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
  ...
  },
  {
    ...
    notes: 'Yaş: 60, Uyruk: Almanya. Hans Brauer\'in eşi ve sadık otel müdavimi Alman hanımefendi.',
    images: [],
    archived: false,
    isProposal: true,
    metadata: {
